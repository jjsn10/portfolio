  ...
  return (
    <>
      <section className="p-8 mx-8">
        <h1 className="font-bold text-4xl my-2 lg:w-2/4">
          Software I use, gadgets I love, and other things I recomended.
        </h1>
        <p className="text-base py-4 lg:w-2/4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
          magna aliqua. Ornare arcu dui vivamus arcu felis bibendum. Feugiat scelerisque varius morbi enim. Sed nisi
          lacus sed viverra tellus in hac habitasse. Volutpat ac tincidunt vitae semper quis. Dis parturient montes
          nascetur ridiculus.{" "}
        </p>
      </section>
